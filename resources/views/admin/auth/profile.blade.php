...
<title>University Profile | University </title>
@section('content')
                    ...
                    <form action="" id="admin_profile">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="contact_no" id="" value="{{$admin->contact_no}}" placeholder="Full Name">
                                </div>
                            </div>
                            <div class="form-group row">
...
<script>
    ...
    var urls='{{ route("university.profileupdate") }}';
